...
class ItemAdmin(admin.ModelAdmin):
    list_display = (
    'photo', 'name', 'price', 'category', 'ages', 'size', 'gender', 'publication_date', 'location', 'user',)
    list_filter = ('category', 'ages', 'size', 'gender', 'location', 'user')


@admin.register(UsedItem)
class ItemAdmin(admin.ModelAdmin):
    list_display = ('photo', 'category', 'price', 'ages', 'size', 'gender', 'publication_date', 'location', 'user')
